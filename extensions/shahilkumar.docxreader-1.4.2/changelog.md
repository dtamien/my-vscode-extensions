...
### Fixed
- **Theme Config Precedence** - The `docxreader.theme` setting (configurable via `Ctrl+Shift+P` → "Open Docx Reader Configuration") now correctly takes precedence over VS Code's system theme (Fixes [#27](https://github.com/skfrost19/Docx-Viewer/issues/27), refixes [#25](https://github.com/skfrost19/Docx-Viewer/issues/25))
...
### Added
- **Git Diff Rendering** - Full support for viewing DOCX files in VS Code's built-in diff view (Fixes [#11](https://github.com/skfrost19/Docx-Viewer/issues/11))
- **Synchronized Scrolling** - When comparing documents side-by-side, scrolling one document automatically scrolls the other (Fixes [#9](https://github.com/skfrost19/Docx-Viewer/issues/9))
...
### Fixed
- **Light Theme Support** - Fixed issue where the extension ignored VS Code's light theme setting and always displayed in dark mode (Fixes [#25](https://github.com/skfrost19/Docx-Viewer/issues/25))
...
### Fixed
- **Empty DOCX/ODT Files** - Opening a 0-byte `.docx`/`.odt` now renders as an empty document instead of throwing a conversion error (Fixes [#22](https://github.com/skfrost19/Docx-Viewer/issues/22))
...
### Added
- **Toolbar Hide/Show Functionality** - Users can now hide the toolbar for a cleaner, distraction-free reading experience (Fixes [#19](https://github.com/skfrost19/Docx-Viewer/issues/19))
...
### Fixed
- **Toolbar Distraction Issue** - Resolved complaint about inability to close the toolbar (Issue [#19](https://github.com/skfrost19/Docx-Viewer/issues/19))
...
### Fixed
- **Duplicate Heading Navigation** - Fixed issue [#17](https://github.com/skfrost19/Docx-Viewer/issues/17) where clicking on outline items with duplicate heading names would always navigate to the first occurrence instead of the correct section
