...
suite('Extension Test Suite', () => {
    ...
    test('Empty DOCX renders as empty HTML', async () => {
        ...
        const html = await docx_handler_1.DocxHandler.renderDocx(vscode.Uri.file(emptyDocxPath));
    ...
    test('Empty ODT renders as empty HTML', async () => {
        ...
        const html = await odt_handler_1.OdtHandler.renderOdt(vscode.Uri.file(emptyOdtPath));
        assert.strictEqual(html, '');
    });
});
